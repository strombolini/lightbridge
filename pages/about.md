---
header_title: About
header_intro: "LightBridge Foundation empowers underserved communities by placing offline, AI‑powered knowledge kiosks where the internet cannot yet reach. We combine modern technology with local partnerships to spark healthier, better‑informed, and more prosperous futures."
layout: page
permalink: /:basename/
---

## Who We Are
LightBridge Foundation is a nonprofit initiative dedicated to closing the last‑mile information gap. Where connectivity stops, misinformation and missed opportunity often thrive. We step in with palm‑sized “AI libraries” that run locally—no data plan, tower, or satellite required—so every question can meet a trustworthy answer.
...
| Name | Role | Focus |
|------|------|-------|
| **Timofei Babenko** | Director of Operations | Oversees global deployments, supply‑chain logistics, and technical reliability of our AI kiosks. |
| **Neva Crounse** | On‑Site Investigator | Embeds with local partners, conducts needs assessments, and ensures culturally relevant content and training. |
| **Ivan Russell** | Accountant | Manages transparent budgeting, donor reporting, and audit‑ready financial stewardship. |
...
> **Contact:** <info@lightbridge.foundation>  
> Follow us on Twitter <https://twitter.com/LightBridgeFdn>
